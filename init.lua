...
require('lazy').setup({
  ...
  }, -- handles auto-closing HTML tags and smarter HTML tag renaming (when using ciw, for example)
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    dependencies = {
      ...
      -- telescope-live-grep-args for adding grep args
    ...
    config = function()
      ...
      -- vim.keymap.set('n', '<leader>fg', builtin.live_grep, { desc = '[F]ind by [G]rep' }) -- default grep (no args)
